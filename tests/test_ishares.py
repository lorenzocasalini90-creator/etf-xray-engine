...
# Real iShares UK UCITS CSV does NOT include ISIN/SEDOL/CUSIP columns.
# The parser adds them as None via validate_output(). Identity resolution
# relies on holding_ticker (e.g. AAPL) being resolved downstream by FigiResolver.
SAMPLE_UCITS_CSV = """\
...
AAPL,APPLE INC,Information Technology,Equity,"46,567,770,000",6.65,"46,567,770,000","188,816,321",246.63,United States,NASDAQ,USD
MSFT,MICROSOFT CORP,Information Technology,Equity,"34,281,620,000",4.90,"34,281,620,000","95,502,629",358.96,United States,NASDAQ,USD
NVDA,NVIDIA CORP,Information Technology,Equity,"51,620,030,000",7.37,"51,620,030,000","312,526,688",165.17,United States,NASDAQ,USD
AMZN,AMAZON COM INC,Consumer Discretionary,Equity,"25,300,000,000",3.61,"25,300,000,000","125,000,000",202.40,United States,NASDAQ,USD
GOOGL,ALPHABET INC CLASS A,Communication,Equity,"14,200,000,000",2.03,"14,200,000,000","85,000,000",167.06,United States,NASDAQ,USD
...
META,META PLATFORMS INC CLASS A,Communication,Equity,"17,000,000,000",2.43,"17,000,000,000","28,000,000",607.14,United States,NASDAQ,USD
"""
